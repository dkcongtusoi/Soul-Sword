...
if can_option{
	draw_text_transformed_color(display_get_gui_width()/2 - 550, display_get_gui_height() - 154, "[LEFT] Kill Hong'er", scale1, scale1, 0, color1, color1, color1, color1, alpha1);

	draw_text_transformed_color(display_get_gui_width()/2 + 550, display_get_gui_height() - 154, "Spare Hong'er [RIGHT]", scale2, scale2, 0, color2, color2, color2, color2, alpha2);
}
